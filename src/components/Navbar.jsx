        ...
        <div 
            ...
            <div className="flex-1">
                <div className="flex items-center gap-3">
                    <a href="https://github.com/Calvinismee" target="_blank" rel="noopener noreferrer" className="btn btn-ghost btn-circle social-icon">
                    ...
                    <a href="https://www.linkedin.com/in/jcalvink/" target="_blank" rel="noopener noreferrer" className="btn btn-ghost btn-circle social-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
